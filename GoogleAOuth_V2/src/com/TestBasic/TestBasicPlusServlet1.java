 ...
 * @author Nick Miceli
 */
public class TestBasicPlusServlet1 extends HttpServlet {

  /**
   * Enter your API key here from https://code.google.com/apis/console/?api=plus under "API Access".
   */
  private static final String API_KEY = "AIzaSyAXCwPCjgzwB2RNB9L_6oB-UFXsPyuAF-U";
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    ...
    ActivityFeed myActivityFeed = plus.activities().search("Dance").execute();
